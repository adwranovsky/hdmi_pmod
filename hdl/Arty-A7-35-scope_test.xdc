...
## Pmod Header JB
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVDS_25 } [get_ports { tmds_p_o }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVDS_25 } [get_ports { tmds_n_o }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
